...
//        }
        ...
        let applicationContainerURL = ApplicationManager.getDataDir(bundleID: application.bundleIdentifier)
...
//            .appendingPathComponent("Groups")
        ...
        let applicationContainerURL = ApplicationManager.getDataDir(bundleID: app.bundleIdentifier)
