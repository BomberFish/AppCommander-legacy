...
public class IconStateManager {
    ...
    public func sortPages(selectedPages: [Int], sortOption: SortOption, pageSortingOption: PageSortingOption, folderSortingOption: FolderSortingOption) throws {
        ...
        do {
            ...
            throw "New IconState appears to be invalid. Sorting has been aborted, and no system files have been edited. Specific error: \(error.localizedDescription). Please screenshot and report to #appcommander."
        }
    }
